...
import 'package:soapy_app/electrician/list_electrician_page.dart';
import 'package:soapy_app/pages/customs/colors.dart';
import 'package:soapy_app/pest%20control/list_pest_control_page.dart';

class ElectricianMainPage extends StatefulWidget {
  const ElectricianMainPage({super.key});

  @override
  State<ElectricianMainPage> createState() => _ElectricianMainPageState();
}

class _ElectricianMainPageState extends State<ElectricianMainPage> {
    ...
    switch (index) {
      case 0:
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => ListElectricianPage(
      ...
      case 5:
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => ListElectricianPage(
                      categories: 'Inverter & Stabiliser',
                    )));
        // Action for Desting
        print('Bed Bugs Control------------------');
        break;
